...
class AssignmentGradebookByQuestionAndStudentTest extends TestCase
{
    ...
    public function correctly_computes_the_percent_correct_by_student()
    {
        ...
        $response = $this->actingAs($this->user)->getJson("/api/scores/assignment/get-assignment-questions-scores-by-user/{$this->assignment->id}/0/0");
    ...
    public function non_owner_cannot_get_the_assignment_scores_by_question_and_user()
    {
        ...
        $this->actingAs($this->user_2)->getJson("/api/scores/assignment/get-assignment-questions-scores-by-user/{$this->assignment->id}/0/0")
    ...
    {
        $this->actingAs($this->user)->getJson("/api/scores/assignment/get-assignment-questions-scores-by-user/{$this->assignment->id}/0/0")
