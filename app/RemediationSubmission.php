       ...
       $authorized = Gate::inspect('store', [$remediationSubmission, $assignment, $assignment->id, $data['question_id']]);
        ...
        try {
            ...
            if ($assignment_question_learning_tree->learning_tree_success_criteria === 'time based') {
                $response['message'] = $correct_submission ? 'Your submission was correct.' : 'Your submission was not correct. Please try again.';
                $response['traffic_light_color'] = $correct_submission ? 'green' : 'yellow';
