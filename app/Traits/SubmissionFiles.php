...
trait SubmissionFiles
{
    ...
    function getFormattedSubmissionFileInfo($submission_file, int $assignment_id, $helpers): array
    {
        ...
        $formatted_submission_file_info['date_submitted'] = isset($submission_file['date_submitted'])
            ? $helpers->convertUTCMysqlFormattedDateToHumanReadableLocalDateAndTime($submission_file['date_submitted'], Auth::user()->time_zone, 'n/j/y g:ia')
            : 'N/A';
        $formatted_submission_file_info['date_graded'] = ($submission_file['date_graded'])
            ? $helpers->convertUTCMysqlFormattedDateToHumanReadableLocalDateAndTime($submission_file['date_graded'], Auth::user()->time_zone, 'n/j/y g:ia')
            : 'N/A';
