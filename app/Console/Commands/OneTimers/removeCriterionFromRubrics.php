...
class removeCriterionFromRubrics extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'remove:CriterionFromRubrics';
    ...
    private function _fixRubric($rubric_to_fix)
    {
        ...
        foreach ($rubric['rubric_items'] as &$value) {
            if (isset($value['criterion'])) {
                $value['title'] = $value['criterion'];
