    ...
    function getQuestionsWithCourseLevelUsageInfo(Request $request, AssignmentTopic $assignmentTopic)
    {
        ...
        switch ($request->collection_type) {
            case('assignment'):
                ...
                $potential_questions_query = $request->topic_id
                    ? $potential_questions_query->where('assignment_topic_id', $request->topic_id)
                    : $potential_questions_query->whereIn('assignment_question.assignment_id', $assignment_ids);
