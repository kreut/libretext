        ...
        try {
            ...
            if ($assignment->assessment_type === 'learning tree') {
                ...
                foreach ($learning_trees as $learningTree) {
                    $number_of_learning_tree_branches_by_question_id[$learningTree->root_node_question_id] = count($learningTree->finalQuestionIds());
                }
...
//don't show the solution if they have an override
                ...
                if ($assignment->assessment_type === 'learning tree') {
                    ...
                    $assignment->questions[$key]['number_of_learning_tree_branches'] = $number_of_learning_tree_branches_by_question_id[$question->id] ?? 0;
