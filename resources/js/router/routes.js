...
let general_paths = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'account_customizations', name: 'settings.account_customizations', component: page('settings/account_customizations.vue')
      }
    ]
  },
  {
    ...
    children: [
      ...
      {
        path: 'lab',
        name: 'instructors.assignments.lab_report',
        component: page('instructors/assignment_information/lab_report.vue')
      },
      {
        path: 'summary',
