...
export default {
  name: 'IframeInformation',
  components: { ToggleButton },
  props: {
    assignmentInformationShownInIFrame:
      {
        type: Boolean,
        default: false
      },
    submissionInformationShownInIFrame:
      {
        type: Boolean,
        default: false
      },
    attributionInformationShownInIFrame:
      {
        type: Boolean,
        default: false
      },
    parentUpdateShownInIFrame:
      {
        type: Function,
        default: function () {
        }
