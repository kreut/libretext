    ...
    >
      ...
      <div v-if="questionForm.technology === 'qti'">
        ...
        <div v-if="qtiQuestionType === 'drop_down_rationale_triad'">
          <b-alert show variant="info">
            <p>
              The structure of a “triad rationale” question is, “The client is at risk for developing X as evidenced by Y
              and Z.”
              X is pulled from a pool of choices (the condition) and Y and Z are pulled from the same pool of choices (the
              rationales).
