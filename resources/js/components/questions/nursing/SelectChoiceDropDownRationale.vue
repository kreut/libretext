  ...
  watch: {
    selectChoices (newSelectChoices) {
      if (this.qtiJson.inline_choice_interactions &&
        ...
        console.log(this.qtiJson.dropDownRationalType === 'dyad')
        console.log(newSelectChoices.length)
        if (this.qtiJson.dropDownRationalType === 'dyad' && newSelectChoices.length === 3) {
        ...
        if (this.qtiJson.dropDownRationalType === 'triad' && newSelectChoices.length === 4) {
