    ...
    <div class="col-lg-8 m-auto">
      ...
      <form @submit.prevent="register" @keydown="form.onKeydown($event)">
        ...
        <b-card h header-html="<h2 class=&quot;h5&quot;>Register With ADAPT</h2>">
          <!-- Name -->
          <p v-if="isTester">
            Tester accounts are special accounts used by those who work in campus testing centers to help administer
            exams on behalf of instructors.
          </p>
          <p v-if="(isTester || isInstructor) && !form.access_code">
            To register as an <span v-if="isInstructor">instructor</span><span v-if="isTester">tester</span>, please
            fill out the form below using your
