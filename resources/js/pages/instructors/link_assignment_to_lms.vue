  ...
  <div>
    ...
    <div v-if="user.role === 3">
      <b-alert show variant="info">
        This assignment is not yet linked to an ADAPT assignment.  Please contact your instructor to let them know.
      </b-alert>
    </div>
    <div v-if="user.role === 2">
      ...
      <div v-if="![2,3].includes(user.role)">
        <b-alert show variant="info">
          You do not have a supported role for this LMS context.  Please contact ADAPT support.
        </b-alert>
      </div>
    </div>
  </div>
