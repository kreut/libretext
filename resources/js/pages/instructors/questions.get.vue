                          ...
                          >
                            ...
                            >
                              ...
                              <td v-if="chosenAssignmentId && !chosenTopicId">
                                {{ assignmentQuestion.topic ? assignmentQuestion.topic : 'None' }}
                              </td>
...
export default {
  ...
  methods: {
    ...
    initFolderAction (action, questionsFolder = {}) {
      switch (action) {
        case ('new'):
        ...
        case ('delete'):
          ...
          this.$refs.moveOrRemoveQuestionsMyFavorites.initDeleteSavedQuestionsFolder(this.isTopic, topicsOptions, questionsFolder)
          break
      }
    },
