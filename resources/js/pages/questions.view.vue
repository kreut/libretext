    ...
    >
      <b-container>
        ...
        <div class="text-center" style="font-size: large">
          ...
          <div v-if="questions[currentPage - 1] && !questions[currentPage - 1].answered_correctly_at_least_once">
            ...
            <b-row>
              ...
              <b-col id="learning_tree_messages">
                <b-alert :show="user.role === 2" variant="info">
                  Learning Tree functionality is available in in Student View. Time based Learning Trees are set to 6 seconds for testing purposes.
                </b-alert>
                ...
                >
                  <b-alert :show="user.role === 2 && assignmentQuestionLearningTreeInfo.learning_tree_success_level === 'tree'"
                           variant="info"
                  >
              ...
              <div>
                <div :class="nonTechnologyClass">
                  <b-container v-if="assessmentType === 'learning tree' && learningTreeBranchOptions.length > 1">
                    ...
                    <hr>
                    <p>Choose a branch to gain a better understanding of an underlying concept.
                  ...
                  <div v-if="!showQuestion && learningTreeBranchOptions <=1">
                    ...
                    <b-alert :show="remediationToView.answered_correctly" variant="success">
                      Already answered correctly. Will not count towards a Root Assessment reset.
                    </b-alert>
                    </div>
