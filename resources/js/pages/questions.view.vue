              ...
              >
                <span v-if="showCountdown">
                  ...
                  <span v-show="assessmentType !== 'clicker' && user.role === 3">
                    <a id="hide-time-until-due-tooltip"
                       href=""
                       class="pr-1"
                       @click.prevent="showCountdown = false"
                    >
                      <b-icon icon="eye-slash"
                              class="font-weight-bold text-primary"
                              aria-label="Hide time until due"
                      />

                    </a>
                    <b-tooltip target="hide-time-until-due-tooltip"
                               triggers="hover focus"
                               delay="250"
                    >
                      Hide the time until due.
                    </b-tooltip>
                  </span>
