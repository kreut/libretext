          ...
          <b-container>
            ...
            <ul style="list-style-type:none" class="p-0">
              ...
              <li v-if="instructorInNonBasicView()">
                <b-form-row>
                  This question is worth <span v-show="!showUpdatePointsPerQuestion" class="pl-1 pr-1"> {{ 1 * (questions[currentPage - 1].points) !== 1 ? 's' : '' }} </span>
                  <b-form-input
              ...
              <li v-if="studentShowPointsNonClicker()">
                ...
                >
                  <span v-show="showCountdown">
                    ...
                    <b-icon-eye-slash class="font-weight-bold text-primary" @click="showCountdown = false" />
                  </span>

                  <span v-if="!showCountdown">
                    <b-button size="sm" variant="outline-info" @click="showCountdown = true">Show Time Until Due</b-button>
                  </span>
                </div>
                <div v-else>
