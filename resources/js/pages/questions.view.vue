          ...
          <b-card>
            ...
            <div v-if="formativeQuestionURL">
              ...
              <div class="mb-2 flex d-flex">
                QR Code <QuestionCircleTooltip id="formative-qr-code-tooltip" class="ml-1"/>
        ...
        <div :class="assignmentInformationMarginBottom">
          <b-container>
            ...
            <ul style="list-style-type:none" class="p-0">
              ...
              <li v-if="(!isFormatiave && !inIFrame && timeLeft>0)
            ...
            <div v-if="instructorInNonBasicView()">
              ...
              <b-form-row v-show="!isFormatiave" style="margin-left:0">
          ...
          <b-row>
            <b-col :cols="questionCol">
              ...
              <div>
                ...
                <div v-if="(!inIFrame || showAttribution)
                  ...
                  && !(user.role === 3 && clickerStatus === 'neither_view_nor_submit')
                  && learningTreeBranchOptions <=1" class="pt-2 pb-2"
                >
                  <b-button size="sm" variant="outline-primary" @click="showAttributionModal">
                    <span>
                      Attribution
            ...
            >
                      ...
                      <span>
                        ...
                        >
                          <span v-show="!freePassForSatisfyingLearningTreeCriteria">
                            A per attempt penalty of {{ numberOfAllowedAttemptsPenalty }}% is applied after the first
                            attempt. </span>
                          <span v-show="freePassForSatisfyingLearningTreeCriteria">  A per attempt penalty of {{ numberOfAllowedAttemptsPenalty }}% is applied after the second
                            attempt. </span>
              ...
              <b-row v-if="(questions[currentPage-1].technology === 'qti' || questions[currentPage-1].technology_iframe)
                && showSubmissionInformation && showQuestion && assessmentType !== 'learning tree' && !isFormatiave"
              >
...
export default {
  ...
  methods: {
    ...
    studentShowPointsNonClicker () {
      return this.source === 'a' && !this.inIFrame && !this.isAnonymousUser && !this.isInstructorWithAnonymousView && !this.isInstructor() && this.user.role !== 5 && this.showPointsPerQuestion && this.assessmentType !== 'clicker' && !this.isFormatiave
    },
    studentNonClicker () {
    ...
    setQuestionCol () {
      ...
      if (this.isFormatiave && this.user.role === 3) {
        this.questionCol = 12
      }
    },
    ...
    createQrCode () {
      qrCodeConfig.data = this.formativeQuestionURL
    ...
    async updateLastSubmittedAndLastResponse (assignmentId, questionId) {
      try {
        ...
        if (!this.submitButtonActive) {
          this.hideSubmitButtonsIfCannotSubmit(this.questions[this.currentPage - 1]['technology'])
        }
    ...
    async getAssignmentInfo () {
      try {
        ...
        this.isFormatiave = assignment.is_formative_course || assignment.formatiave
