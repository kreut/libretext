        ...
        >
          ...
          <b-container>
            ...
            >
              ...
              >{{ currentNode.branch_description }}</a></span>
...
import { faTree, faThumbsUp, faCheck, faArrowLeft, faArrowRight } from '@fortawesome/free-solid-svg-icons'
...
export default {
  ...
  methods: {
    ...
    updateAutoAttribution (license, licenseVersion, author) {
      ...
      if (['ccby', 'ccbynd', 'ccbyncnd', 'ccbync', 'ccbyncsa'].includes(license)) {
        url += '/' + licenseVersion
      }
